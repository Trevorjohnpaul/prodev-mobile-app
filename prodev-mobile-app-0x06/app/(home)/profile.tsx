    ...
    <SafeAreaProvider>
      <SafeAreaView className="flex-1 p-4 bg-gray-100">
        ...
        <View className="h-[350px] gap-3 bg-white rounded-md p-4 mb-4">
          ...
          {/* Repeat similar Pressable blocks for Saved Beneficiary, FaceID, 2FA, Logout */}
          {/* You can copy the rest from your provided content */}
        </View>

        <Text className="text-black text-xl font-normal mb-6">More</Text>
        <View className="h-[139px] gap-3 bg-white rounded-md p-4 mb-4">
          {/* More items like My Account, Saved Beneficiary */}
        </View>
      </SafeAreaView>
    </SafeAreaProvider>
  );
